(() => {
    ...
    function initSliders() {
        if (document.querySelector(".menu-footer__slider") && window.innerWidth <= 600) new core(".menu-footer__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 5,
            ...
            speed: 800,
            navigation: {
                prevEl: ".menu-footer__swiper-button-prev",
                nextEl: ".menu-footer__swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 4
